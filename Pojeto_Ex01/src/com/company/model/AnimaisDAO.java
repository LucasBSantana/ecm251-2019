...
public class AnimaisDAO {
    ...
    private final String kUpdateAnimal(Animal animal){
        return "UPDATE "+ kTableName+ " SET nome=\"" +animal.nome+"\", " + "lat=" + animal.lat + ", "
                + "lon=" + animal.lon + ", " + "altura=" + animal.altura + ", " + "peso=" + animal.peso + ", "
                + "tipo=\"" + animal.tipo + "\" WHERE id=" + animal.getId()+";";
    }
    private final String kDeleteAnimal(Animal animal){
        return "DELETE FROM "+kTableName+" WHERE id="+animal.getId()+";";
    }
