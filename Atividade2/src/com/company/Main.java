//Lucas Brancatelli Santana 17.00895-6
//Felipe Sanger 17.02225-8
package com.company;
...
public class Main {
    ...
    static public void menuCateg(Produto.departamento depTemp){
        int op;
         do {
            System.out.println("Produtos da categoria.");
            System.out.println(loja.exibirCategoriasDeProdutos(loja.listaPorDepartamento(depTemp)));
            System.out.println("[30] - Retornar ao menu anterior");
